...
namespace mp
{
    public class DB_Ops
    {
        private SqlConnection con = new SqlConnection("Data Source = SQL5104.site4now.net; Initial Catalog = db_a74732_anthropology; User Id = db_a74732_anthropology_admin; Password=nargacuga5");
